                ...
                <div class="col-md-12">
                    <form action="" method="post">
                        <div class="card shadow-lg p-3 mb-5 bg-white rounded" style="width: 1280px; margin-top: 90px; margin-left: -80px;">
                            <div class="card-body">
                                <h1 class=" card-title display-2 text-secondary" style="margin-top: -17px;">Report Generation</h1>
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        <td>
                                            <input type="submit" value="Generate Report" name="b1" class="btn btn-Primary"/><br>
                                        </td>
                                    </tr>
                                </table>
                            </div>
